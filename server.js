...
const express = require('express'),
    ...
    LearnObjs = require('./source/models/courses/learnobj'),
    LearningResource = require('./source/models/courses/learnres'),
    LearnResVid = require('./source/models/courses/learnresvid'),
    LearnResRead = require('./source/models/courses/learnresread'),
    LearnResQuiz = require('./source/models/courses/learnresquiz'),
    LearningNotes = require('./source/models/courses/learnnotes'),
